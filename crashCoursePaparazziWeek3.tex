...
Create a module now and try to add it to your airframe file. 
...
\end{verbatim}
Fly and verify that your program works. Now you know that you can complex function in your module, and call them from your flightplan. 
...
Now you should be able to set a waypoint in one corner of the arena(away from the net), and move this waypoint in the shape of a quare or house by placing it at different points in the arena as soon as you reach them. 
