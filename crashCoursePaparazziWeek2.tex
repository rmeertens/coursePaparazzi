...
When starting paparazzi with the start.py program \fbox{/paparazzi\$python start.py}, make sure you select as Conf: \fbox{userconf/TUDELFT/tudelft\_course2018\_conf.xml} and as Controlpanel:

\fbox{userconf/TUDELFT/tudelft\_course2018\_control\_panel.xml}. 
...
\fbox{flight\_plans/TUDELFT/tudelft\_course2018\_avoid\_orange.xml} to see how these exceptions are implemented. 
