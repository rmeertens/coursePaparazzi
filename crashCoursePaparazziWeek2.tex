...
\end{itemize}
The Paparazzi flight plan allows you to create exceptions: when the check of that exception becomes true the drone will execute a certain block. Look at the flight plan file flight\_plans/TUDELFT/tudelft\_course2016\_avoid\_orange.xml to see how these exceptions are implemented. 
\end{document}
